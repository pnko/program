...
### 머신러닝
 ...
 - 어느정도 규모의 데이터 -> 데이터의 일정한 규칙 찾기 -> 규칙 기반으로 다른 데이터 분류하거나 미래 예측
* 머신러닝의 종류 : 지도학습, 비지도학습, 강화학습
  - 지도학습 : 데이터/답 입력 => 학습 => 새로은 데이터의 답 예측
  - 비지도학습 : 데이터 입력 => 학습 => 다른 데이터의 규칙성을 찾습니다.
  - 강화학습 : 부분적 답 입력 -> 학습 => 데이터 기반으로 최적의 답을 찾습니다.
